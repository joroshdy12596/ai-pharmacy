...
# This works for the current user and does not require admin privileges.
...
Register-ScheduledTask `
    ...
    -Action $action `
    -Settings $settings `
    -Description "Automatically commits changes and pushes them to GitHub every 30 minutes" `
    -Force
